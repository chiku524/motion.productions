...
Procedural registry field (visible named color/sound masses) — not photorealistic yet. Photoreal is a later consumer of the same prompt → registry → field contract, not an external trained model.
