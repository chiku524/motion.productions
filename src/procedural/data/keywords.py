...
KEYWORD_TO_SETTING: dict[str, str] = {
    "city": "city",
    "urban": "city",
    "tokyo": "city",
    "street": "city",
...
SETTING_VISUAL_DEFAULTS: dict[str, dict[str, str]] = {
    "city": {"palette": "neon", "lighting": "neon", "gradient": "vertical"},
    "neon": {"palette": "neon", "lighting": "neon", "gradient": "angled"},
    "ocean": {"palette": "ocean", "lighting": "documentary", "gradient": "horizontal"},
    "beach": {"palette": "warm_sunset", "lighting": "golden_hour", "gradient": "horizontal"},
    "underwater": {"palette": "ocean", "lighting": "moody", "gradient": "radial"},
    "forest": {"palette": "forest", "lighting": "documentary", "gradient": "vertical"},
    "night": {"palette": "night", "lighting": "noir", "gradient": "radial"},
    "noir": {"palette": "night", "lighting": "noir", "gradient": "vertical"},
    "golden_hour": {"palette": "warm_sunset", "lighting": "golden_hour", "gradient": "radial"},
    "day": {"palette": "default", "lighting": "documentary", "gradient": "vertical"},
    "desert": {"palette": "warm_sunset", "lighting": "golden_hour", "gradient": "horizontal"},
    "mountain": {"palette": "mono", "lighting": "documentary", "gradient": "vertical"},
    "space": {"palette": "night", "lighting": "noir", "gradient": "radial"},
    "studio": {"palette": "mono", "lighting": "documentary", "gradient": "radial"},
    "interior": {"palette": "mono", "lighting": "documentary", "gradient": "vertical"},
    "exterior": {"palette": "default", "lighting": "documentary", "gradient": "horizontal"},
