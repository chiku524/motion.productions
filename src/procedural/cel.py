"""
Cel cartoon kit — Pillow ImageDraw: hard ink outlines, flat fills, modern-day
rooms and a TV-cartoon figure. Unique per clip via registry colors + seed.

Does not load or replay a reference clip / loop-origin field.
"""
...
def render_cel_frame(
    ...
    *,
    ...
    """One RGB uint8 frame: room kit + inked character. Never replays a reference clip."""
