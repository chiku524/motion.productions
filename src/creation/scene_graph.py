...
def cartoon_hold_snap_keyframes(
    *,
    duration: float,
    direction: str = "right",
    travel: float = 0.16,
    ...
    return [
        ...
        LayerKeyframe(t=snap, x=x1, y=y, scale=1.12, rot=0.18),
        LayerKeyframe(t=settle, x=x1, y=y, scale=1.0, rot=0.0),
        LayerKeyframe(t=duration, x=x1, y=y, scale=1.0, rot=0.0),
    ]
